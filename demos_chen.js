...
function getDemoTheme() {
    ...
    var url = "https://www.jqwidgets.com/jquery-widgets-demo/jqwidgets/styles/jqx." + theme + '.css';
    if (theme === "light" || theme === "dark") {
		...
		{
			  url = "https://www.jqwidgets.com/jquery-widgets-demo/jqwidgets/styles/jqx." + theme + '-ie.css';
		}
	}
